...
class FormTwo extends StatefulWidget {
  ...
  const FormTwo({super.key, required this.tableName});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          databaseController.searchModel(value);
                        });
                      },
                ...
                FutureBuilder<void>(
                  future: fetchModels(controller.brand.value),
                      ...
                      return Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final model = _searchKeyController.text.isNotEmpty
                                ? searchBrands[index]
                                : models[index];
